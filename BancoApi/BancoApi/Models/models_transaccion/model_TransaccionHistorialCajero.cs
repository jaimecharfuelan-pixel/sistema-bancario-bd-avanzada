...
namespace BancoApi.Models.models_transaccion
{
    ...
    public class model_TransaccionHistorialCajero
    {
        private readonly DTO_TransaccionHistorialCajero _dto;

        public model_TransaccionHistorialCajero(DTO_TransaccionHistorialCajero dto)
        {
