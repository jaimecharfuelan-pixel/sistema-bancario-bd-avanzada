...
namespace BancoApi.Models.models_cuenta
{
    ...
    public class model_CuentaObtenerPorIds
    {
        private readonly DTO_CuentaObtenerPorIds _dto;
        private List<int>? _idsNormalizados;

        public model_CuentaObtenerPorIds(DTO_CuentaObtenerPorIds dto)
        {
...
public void Validar()
        {
            ...
            {
                throw new ArgumentException("Debe proporcionar al menos un ID de cuenta");
            }
